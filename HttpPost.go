 ...
 * @return err error
 */
func HttpPost(pTransport *http.Transport, url string, pHeaderMap *map[string]string, timeout time.Duration, dataIn []byte) (httpCode int, dataOut []byte, cookieList []*http.Cookie, err error) {
