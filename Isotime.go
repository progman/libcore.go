...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
func UnixnanotimeUnpack(unixnanotime int64) (target Time) {
...
func Unixnanotime2iso(unixnanotime int64) (iso string) {
	...
	t1 = UnixnanotimeUnpack(unixnanotime)
...
func UnixnanotimeCropPerDay(unixnanotimeSource int64) (unixnanotimeTarget int64) {
	...
	var t1 Time
	t1 = UnixnanotimeUnpack(unixnanotimeSource)
...
func isotime_test() bool {
	...
	t1 = UnixnanotimeUnpack(1624120658256315911)
